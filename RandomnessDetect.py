...
def check_randomness(step):
    print("### RANDOMNESS CHECK: %s"  % step)
    print("Hash\t: %s" % "hello".__hash__())
    print("Random\t: %s" % rn.randint(0,10))
    print("Numpy\t: %s" % np.random.randint((100)))
...
check_randomness("After loading")
...
check_randomness("After tokenize")
